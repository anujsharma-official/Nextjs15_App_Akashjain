 ...
 return (
   <div>
     ...
     <div className='lg:px-40 px-5 py-20'>
       ...
       <p>Welcome to <i><b>STYLITHIC FASHIONS</b></i>, your one-stop destination for quality, convenience, and innovation in online shopping.</p>
       <p>Founded with a mission to redefine the E-Commerce experience, we are passionate about bringing you a carefully curated selection of products that meet your everyday needs—whether it's fashion,  home essentials, beauty, or lifestyle goods. Our goal is to deliver not just products, but value, trust, and a seamless shopping journey.</p>
       ...
       <p className='mt-3'>
       Thank you for choosing <i><b>STYLITHIC FASHIONS</b></i>. Let&apos;s make shopping smarter, simpler, and more enjoyable—together.
       </p>
     </div>
   </div>
 )
