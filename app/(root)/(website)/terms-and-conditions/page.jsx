    ...
    return (
        <div>
            ...
            <div className='lg:px-40 px-5 py-20'>
                ...
                <p>Welcome to <i><b>STYLITHIC FASHIONS</b></i>. By accessing or using our website, you agree to be bound by the following terms and conditions. Please read them carefully.</p>
                ...
                <ul className='list-disc ps-10 mt-3'>
                    <li>All content on <i><b>STYLITHIC FASHIONS</b></i>, including logos, images, and text, is the property of <i><b>STYLITHIC FASHIONS</b></i> and protected by copyright laws.</li>
                ...
                <p className='mt-3'>
                    Thank you for choosing <i><b>STYLITHIC FASHIONS</b></i>. We value your trust and are committed to delivering a secure and reliable shopping experience.
                </p>
            </div>
        </div>
    )
