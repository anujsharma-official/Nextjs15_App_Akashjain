...
export async function POST(request) {
    try {
        ...
        if (!getUser.isEmailVerified) {
            ...
            await sendMail('Email Verification request from Stylithic Fashions', email, emailVerificationLink(`${process.env.NEXT_PUBLIC_BASE_URL}/auth/verify-email/${token}`))
