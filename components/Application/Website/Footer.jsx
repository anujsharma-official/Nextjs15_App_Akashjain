    ...
    <footer className="bg-gray-50 border-t">
      <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-10 py-10 lg:px-32 px-4">
        <div className="lg:col-span-1 md:col-span-2 col-span-1">
          ...
          <p className="text-gray-500 text-sm">
            <b>Stylithic Fashions</b> — your trusted destination for style,
            quality, and everyday convenience. From timeless fashion to daily
            essentials, we deliver everything you need, straight to your
            doorstep. Shop smarter, live better, and experience the difference —
            only with <b>Stylithic Fashions</b>.
          </p>
        </div>
          ...
          <ul>
            <li className="mb-2 text-gray-500 flex gap-2">
              ...
              <span className="text-sm">
                5, Raj Nagar, Rampura Road, Hajya Wala, Sanganer, Jaipur –
                302020
              </span>
            </li>
            ...
            <li className="mb-2 text-gray-500 flex gap-2">
              ...
              <Link
                href="mailto:Stylithic.sup.1304@gmail.com"
                className="hover:text-primary text-sm"
              >
                Stylithic.sup.1304@gmail.com
              </Link>
            </li>
          </ul>
      ...
      <div className="py-4 sm:py-5 bg-gray-100 border-t">
        <p className="text-center text-xs sm:text-sm text-gray-600">
          ...
          <span className="font-semibold">Stylithic Fashions™</span>. All Rights
          Reserved.
        </p>
      </div>
    </footer>
